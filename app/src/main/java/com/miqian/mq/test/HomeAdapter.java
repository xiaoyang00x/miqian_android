...
public class HomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    switch (viewType) {
      ...
      case DEMAND_DEPOSIT:
        View view =
            mInflater.inflate(R.layout.fragment_home_recyclerview_item_demand_deposit, parent, false);
      ...
      default:
        View v =
            mInflater.inflate(R.layout.fragment_home_recyclerview_item_regular_deposit, parent, false);
