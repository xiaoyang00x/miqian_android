...
public class MaterialProgressBarSupport extends ViewGroup {
  ...
  private void createProgressView(AttributeSet attrs) {
    ...
    final TypedArray a =
        getContext().obtainStyledAttributes(attrs, R.styleable.MaterialProgressBarSupport);
    if (a.hasValue(R.styleable.MaterialProgressBarSupport_progressSmallSize)) {
      boolean isSmallSize =
          a.getBoolean(R.styleable.MaterialProgressBarSupport_progressSmallSize, true);
    ...
    if (a.hasValue(R.styleable.MaterialProgressBarSupport_progressBackgroundColor)) {
      bgColor = a.getColor(R.styleable.MaterialProgressBarSupport_progressBackgroundColor,
          CIRCLE_BG_LIGHT);
    }

    if (a.hasValue(R.styleable.MaterialProgressBarSupport_progressColor)) {
      progressColor =
          a.getColor(R.styleable.MaterialProgressBarSupport_progressColor, CIRCLE_LIGHT);
    }
    //TypedArray使用完回收
    a.recycle();
