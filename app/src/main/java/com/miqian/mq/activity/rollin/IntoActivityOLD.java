...
// * 充值页面
// */
//public class IntoActivityOLD extends BaseActivity implements View.OnClickListener {
//
...
//        WeakReference<IntoActivityOLD> weakActivity;
//
//        public MyHandler(IntoActivityOLD activity) {
...
//            Intent intent = new Intent(IntoActivityOLD.this, IntoResultActivity.class);
