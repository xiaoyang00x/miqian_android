...
/**
 * @author wangduo
 * @description: 秒钱宝 定期赚 定期计划 定期转让详情页
 * @email: cswangduo@163.com
 * @date: 16/6/2
 */
public class RegularDetailActivityTemp extends BaseActivity {
    ...
    public static void startActivity(Context context, String subjectId, int prodId) {
        Intent intent = new Intent(context, RegularDetailActivityTemp.class);
...
//                break;
    ...
    private void updateRegularTransferDetail() {
        ...
        rlyt_original_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegularDetailActivityTemp.startActivity(getBaseContext(), mInfo.getOriginalSubjectId(), mInfo.getProdId() - 1);
            }
        });
    }
    ...
    private View.OnClickListener mOnclickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btn_buy:
                    if (!UserUtil.hasLogin(RegularDetailActivityTemp.this)) {
                        UserUtil.showLoginDialog(RegularDetailActivityTemp.this);
                    } else {
