...
/**
 * Created by Jackie on 2015/10/17.
 */
...
public class MySwipeRefresh extends ViewGroup {
...
//        }
    ...
    private void createHeaderViewContainer() {
        ...
        layoutParamsChild.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
        mHeadViewContainer.addView(child, layoutParamsChild);
...
//    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int distance = mCurrentTargetOffsetTop + mHeadViewContainer.getHeight();
        if (!targetScrollWithLayout || isFirstLoad) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mTarget.measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth()
                ...
                MeasureSpec.makeMeasureSpec(getMeasuredHeight()
                        ...
                        MeasureSpec.EXACTLY));
        mHeadViewContainer.measure(MeasureSpec.makeMeasureSpec(mHeaderViewWidth, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(mHeaderViewHeight, MeasureSpec.EXACTLY));
