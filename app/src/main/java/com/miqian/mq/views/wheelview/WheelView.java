...
public class WheelView extends View {
	...
	private static final int ITEMS_TEXT_COLOR = 0xFF8d9091;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		// Paint p=new Paint();
		// Log.e("", "drawCenterRect");
		// p.setColor(ITEMS_TEXT_COLOR);
		canvas.drawLine(0, center - offset, getWidth(), center - offset, itemsPaint);
		canvas.drawLine(0, center + offset, getWidth(), center + offset, itemsPaint);
