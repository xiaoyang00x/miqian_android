...
public class WaterWaveView extends View {
    ...
    private int mWaveColor1 = Color.WHITE;
...
//        }
        // 绘制,即水面静止时的高度
        // 绘制,即水面静止时的高度
        RectF oval = new RectF(centerX  - mScreenWidth / 4, centerY - mScreenHeight / 4, centerX + mScreenWidth / 4, centerX + mScreenHeight / 4);
        canvas.drawArc(oval, startAngle, sweepAngle, false, mWavePaint);
        ...
        // 每次onDraw时c都会自增
        c = (1L + c);
        float f1 = (centerY * 2 + offsetWidth / 4)* (1.0F - (0.25F + mWaterLevel / 2)) - mAmplitude;
        //当前油量线的长度
        ...
        while (startX1 < endX1) {
            ...
            canvas.drawLine(startX1, startY1, startX1, top, mWavePaint1);
            startX1++;
        }
