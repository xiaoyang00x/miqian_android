 ...
 */
public class AdapterRegularList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public static final String TAG = AdapterRegularList.class.getSimpleName();
...
//    private View swipeRefreshLayout;
    ...
    public AdapterRegularList(GetRegularInfo info, Context mContext) {
