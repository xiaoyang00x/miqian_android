        ...
        if (!TextUtils.isEmpty(traCd)) {
            ...
            switch (traCd) {
                case "SR01"://认购交易
                    ...
                    ((ViewHolderRecord) holder).textType.setText("认购");
                ...
                case "SS01"://赎回交易
                    ...
                    ((ViewHolderRecord) holder).textType.setText("赎回");
                    if (!TextUtils.isEmpty(data.getAmt())) {
                        ((ViewHolderRecord) holder).tvAmt.setText("-" + data.getAmt());
                    }
                    if (!TextUtils.isEmpty(data.getInterest())) {
                        ((ViewHolderRecord) holder).tvInterest.setText(data.getInterest()+"元");
                    }
                    break;
                case "SZ01  "://转让交易
                    ((ViewHolderRecord) holder).textType.setText("转让");
